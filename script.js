...
var quotes = [
  ...
  {quote : 'If I have seen further than others, it is by standing upon the shoulders of giants',source : 'Isaac Newton',category : 'inspiration'}
];
...
function getRandomQuote() {
  var randomQuote = quotes[Math.floor(Math.random() * 6)];
  return randomQuote;
}
